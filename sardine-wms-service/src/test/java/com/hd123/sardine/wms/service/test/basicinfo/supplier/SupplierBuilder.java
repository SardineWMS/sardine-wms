...
public class SupplierBuilder extends SupplierBuilderBase<SupplierBuilder> {
    public static SupplierBuilder supplier() {
...
class SupplierBuilderBase<GeneratorT extends SupplierBuilderBase<GeneratorT>> {
    private Supplier instance;

    protected SupplierBuilderBase(Supplier aInstance) {
        instance = aInstance;
        POJORandomInitionlizer.randomInit(instance);
    }

    protected Supplier getInstance() {
        return instance;
    }
    ...
    @SuppressWarnings("unchecked")
    public GeneratorT withState(SupplierState aValue) {
    ...
    public class CreateInfoOperateInfoBuilder
        ...
        public GeneratorT endCreateInfo() {
            return (GeneratorT) SupplierBuilderBase.this;
        }
    }
