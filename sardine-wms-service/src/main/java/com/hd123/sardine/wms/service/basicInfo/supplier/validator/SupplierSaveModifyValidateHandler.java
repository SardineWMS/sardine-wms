 ...
 * 文件名：	SupplierSaveModifyValidateHandler.java
 * 模块说明：	
 * 修改历史：
 ...
 *
 */
public class SupplierSaveModifyValidateHandler extends GenericValidateHandler<Supplier> {
    ...
    protected void prepareValidators(Supplier bean) {
        ...
        on("供应商uuid", bean.getUuid(), notNullValidator);
