...
public class OrderBillServiceImpl implements OrderBillService {
  ...
  public String insert(OrderBill orderBill) throws IllegalArgumentException, WMSException {
    ...
    return orderBill.getBillNumber();
  }
  ...
  @Override
  public void bookReg(String uuid, long version, Date bookDate)
      throws IllegalArgumentException, VersionConflictException, WMSException {
    Assert.assertArgumentNotNull(uuid, "uuid");
  ...
  @Override
  public void check(String uuid, long version)
      throws IllegalArgumentException, VersionConflictException, WMSException {
    Assert.assertArgumentNotNull(uuid, "uuid");
