 ...
 * 文件名：	CustomerInsertValidateHandler.java
 * 模块说明：	
 * 修改历史：
 ...
 *
 */
public class CustomerInsertValidateHandler extends GenericValidateHandler<Customer> {
...
//        on("客户状态", bean.getState(), notNullValidator);
