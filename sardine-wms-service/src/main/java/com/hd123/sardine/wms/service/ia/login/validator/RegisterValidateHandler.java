 ...
 * 文件名：	RegisterValidateHandler.java
 * 模块说明：	
 * 修改历史：
 ...
 * {@link RegisterValidateHandler#KEY_CODEEXISTS_USER}传入</li>
 * </ul>
 * 
 * @author zhangsai
 *
...
public class RegisterValidateHandler extends GenericValidateHandler<User> {
    ...
    protected void prepareValidators(User bean) {
        ...
        on("公司名称", bean.getCompanyName(), notNullValidator);
        on("公司名称", bean.getCompanyName(), length100Validator);
