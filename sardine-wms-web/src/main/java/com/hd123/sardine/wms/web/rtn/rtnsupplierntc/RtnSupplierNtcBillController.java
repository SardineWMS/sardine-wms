...
public class RtnSupplierNtcBillController {
  ...
  public RespObject query(
    ...
    try {
      ...
      definition.put(RtnSupplierNtcBillService.QUERY_STATE_EQUALS,
          StringUtil.isNullOrBlank(state) ? null : RtnSupplierNtcBillState.valueOf(state));
  ...
  public RespObject getRtnSupplierNtcBill(
  ...
  public RespObject updateBill(@RequestParam(value = "token", required = true) String token,
      @RequestBody RtnSupplierNtcBill bill) {
    RespObject resp = new RespObject();
    try {
  ...
  public RespObject abort(@RequestParam(value = "token", required = true) String token,
      @RequestParam(value = "uuid", required = true) String uuid,
  ...
  public RespObject finish(@RequestParam(value = "token", required = true) String token,
      @RequestParam(value = "uuid", required = true) String uuid,
      @RequestParam(value = "version", required = true) long version) {
    RespObject resp = new RespObject();
    try {
  ...
  public RespObject genTask(@RequestParam(value = "uuid", required = true) String uuid,
      @RequestParam(value = "version", required = true) long version) {
    RespObject resp = new RespObject();
    try {
