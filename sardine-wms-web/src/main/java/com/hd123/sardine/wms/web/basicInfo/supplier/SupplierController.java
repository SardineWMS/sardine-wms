...
public class SupplierController extends BaseController {
    ...
    public @ResponseBody RespObject query(
        ...
        try {
            ...
            definition.put(SupplierService.QUERY_STATE_FIELD,
                    StringUtil.isNullOrBlank(state) ? null : SupplierState.valueOf(state));
    ...
    public @ResponseBody RespObject saveModify(@RequestBody Supplier supplier) {
        RespObject resp = new RespObject();
        try {
            supplierService.saveModify(supplier, getOperateContext(supplier.getToken()));
            resp.setStatus(RespStatus.HTTP_STATUS_SUCCESS);
        } catch (Exception e) {
    ...
    public @ResponseBody RespObject online(
        ...
        RespObject resp = new RespObject();
        try {
            supplierService.online(uuid, version, getOperateContext(token));
            resp.setStatus(RespStatus.HTTP_STATUS_SUCCESS);
        } catch (Exception e) {
    ...
    public @ResponseBody RespObject offline(
        ...
        RespObject resp = new RespObject();
        try {
            supplierService.offline(uuid, version, getOperateContext(token));
            resp.setStatus(RespStatus.HTTP_STATUS_SUCCESS);
        } catch (Exception e) {
            return new ErrorRespObject("禁用供应商失败", e.getMessage());
        }
        return resp;
    }
