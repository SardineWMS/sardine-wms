...
public class SerialArchController extends BaseController {
    ...
    public @ResponseBody RespObject createSerialArch(
        ...
        try {
            ...
            arch.setCompanyUuid(getLoginCompany(token).getUuid());
    ...
    public @ResponseBody RespObject createLine(
        ...
        try {
            ApplicationContextUtil.setCompany(getLoginCompany(token));
            ApplicationContextUtil.setOperateContext(getOperateContext(token));
            line.setCompanyUuid(getLoginCompany(token).getUuid());
    ...
    public @ResponseBody RespObject queryCustomerByLine(
        ...
        try {
            ...
            PageQueryResult<SerialArchLineCustomer> result = service
                    .queryCustomerByLine(definition);
