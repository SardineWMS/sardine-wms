...
public class UserController extends BaseController {
    ...
    public @ResponseBody RespObject insert(@RequestBody User user) {
        RespObject resp = new RespObject();
        try {
            String userUuid = userService.insert(user, getOperateContext(user.getToken()));
    ...
    public @ResponseBody RespObject update(@RequestBody User user) {
        RespObject resp = new RespObject();
        try {
            userService.update(user, getOperateContext(user.getToken()));
            resp.setStatus(RespStatus.HTTP_STATUS_SUCCESS);
        } catch (Exception e) {
