...
public class ReturnBillController extends BaseController {
    ...
    public @ResponseBody RespObject query(
            ...
            @RequestParam(value = "returnNtcBillNumber",
                    required = false) String returnNtcBillNumber,
        ...
        try {
            ...
            definition.setSortField(StringUtil.isNullOrBlank(sort)
                    ? ReturnBillService.QUERY_BILLNUMBER_LIKE : sort);
