...
public class BinTypeController extends BaseController {
	...
	public @ResponseBody RespObject getByCode(@RequestParam(value = "bintypeCode") String binTypeCode) {
		RespObject resp = new RespObject();
		try {
	...
	public @ResponseBody RespObject insert(@RequestParam(value = "token", required = true) String token,
	...
	public @ResponseBody RespObject update(@RequestParam(value = "token", required = true) String token,
			@RequestBody BinType binType) {
		RespObject resp = new RespObject();
		try {
