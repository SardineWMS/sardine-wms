...
public interface ReturnSupplierBillService {
   ...
   * 根据退货交接明细生成供应商退货单
   * 
   * @param returnHandoverItems
   *          交接明细，not null
   * @throws IllegalArgumentException
   * @throws WMSException
   */
  void generateReturnSupplierBill(List<ReturnSupplierBillItem> returnHandoverItems)
   ...
   * @throws IllegalArgumentException
   */
  PageQueryResult<ReturnSupplierBillItem> queryWaitHandoverItems(HandoverTaskFilter filter)
      throws IllegalArgumentException;
}
