...
public interface RoleService {
   ...
   * @throws IAException
   */
  String insert(Role role) throws IllegalArgumentException, WMSException;
   ...
   * @throws IAException
   */
  void update(Role role) throws IllegalArgumentException, EntityNotFoundException,
      VersionConflictException, WMSException;
   ...
   * @throws VersionConflictException
   */
  void online(String uuid, long version) throws IllegalArgumentException, EntityNotFoundException,
      VersionConflictException, WMSException;
   ...
   * @throws VersionConflictException
   */
  void offline(String uuid, long version) throws IllegalArgumentException, EntityNotFoundException,
      VersionConflictException, WMSException;
   ...
   * @throws VersionConflictException
   */
  void remove(String uuid, long version) throws IllegalArgumentException, EntityNotFoundException,
      VersionConflictException, WMSException;
   ...
   * 
   */
  List<Role> queryAllRoleByUser(String userUuid) throws IllegalArgumentException;
