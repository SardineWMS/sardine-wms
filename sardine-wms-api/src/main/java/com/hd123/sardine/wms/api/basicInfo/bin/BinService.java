...
public interface BinService {
	 ...
	 * @throws WMSException
	 */
	void remove(String uuid, long version) throws IllegalArgumentException, VersionConflictException, WMSException;
	...
	/**
	 * 封仓，根据仓位和货位范围将对应范围内的空闲货位状态修改为锁定
	 * <p>
	 * <br>
	 * 锁定状态下的货位不可进行上架，移库入，溢余操作<br>
	 * <br>
	 * 封仓操作仅改变该仓位下空闲的货位的状态<br>
	 * <br>
	 * 传入参数不能同时都为空<br>
	 * 
	 * @param uuid
	 ...
	 * @throws IllegalArgumentException
	 */
	void closeWrh(String uuid, String binScope) throws WMSException, IllegalArgumentException;

	/**
	 * 解仓
	 * <p>
	 * 对于已封仓的仓位的操作 解仓后 该仓位下的异常锁定的货位变为空闲状态 <br>
	 * 传入参数不能同时都为空<br>
	 * 
	 * @param binUuid
	 *            仓位uuid
	 ...
	 * @throws IllegalArgumentException
	 */
	void releaseWrh(String uuid, String binScope) throws WMSException, IllegalArgumentException;
}
